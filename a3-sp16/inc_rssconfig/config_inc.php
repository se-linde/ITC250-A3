...
define('VIRTUAL_PATH', 'http://lindese.com/itc250/a3-sp16/'); # Virtual (web) 'root' of application for images, JS & CSS files
define('PHYSICAL_PATH', '/home/sarlin18/lindese.com/itc250/a3-sp16/'); # Physical (PHP) 'root' of application for file & upload reference
define('INCLUDE_PATH', PHYSICAL_PATH . 'inc_rssconfig/'); # Path to PHP include files - INSIDE APPLICATION ROOT
...
define('SUPPORT_EMAIL', 'lindesara@gmail.com'); # Email of site support
