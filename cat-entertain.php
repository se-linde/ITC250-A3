...
// How is the page driven? The class is driven by this same info.     
    ...
    public $EntertainmentID = 0;       // Not a normal Primary Key number. 
    public $FeedURL = '';        // Assign a neutral blank variable to prevent problems.
    ...
    public function __construct($id){
        ...
        $sql = "select Title,FeedURL from sp16_rssfeed_Entertainment where EntertainmentID = " . $id;
...
Don't need Question Class here. Just Survey class; modify.        
