...
{#records exist - show survey!
    ...
    echo '
    <h1> align=center"> Here are your three categories!<h1> 
    <h3 align="center"> ' . $Category . '</h3>
    <h3 align="center"> ' . $URL . '</h3>
    ';
...
// How is the page driven? The class is driven by this same info.     
    ...
    public $CategoryID = 0;       // Not a normal Primary Key number. 
    ...
    public function __construct($id){
        ...
        $sql = "select Category,URL from sp16_rssfeed_Categories where CategoryID = " . $id;
